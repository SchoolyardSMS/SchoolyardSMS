    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      {possibleTerms.length > 0 && (
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
          <label htmlFor="select-term-grade" className="text-sm font-bold text-slate-900 dark:text-white">Select Term to Grade:</label>
          <form className="flex gap-2">
            <select id="select-term-grade" name="termId" defaultValue={selectedTermId || ""} className="h-10 px-3 rounded-lg border border-slate-200 dark:border-slate-800 bg-transparent text-sm min-w-[200px]">
