        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input id="course-code" name="code" type="text" required placeholder="ENG101"
            ...
            <div className="space-y-2">
              <label htmlFor="course-credits" className="text-sm font-medium">Credits <span className="text-red-500">*</span></label>
              <input id="course-credits" name="credits" type="number" min={1} max={6} defaultValue={3}
          ...
          <div className="space-y-2">
            <label htmlFor="course-name" className="text-sm font-medium">Course Name <span className="text-red-500">*</span></label>
            <input id="course-name" name="name" type="text" required placeholder="Introduction to English Literature"
              className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <MarkdownEditor id="course-description" name="description" placeholder="Course overview, prerequisites, learning objectives..." />
          </div>
        </div>
